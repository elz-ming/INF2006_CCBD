...
<body>
  ...
  <main>
    ...
    <section id="answers">
      <button id="answer-1" class="answer"><?= htmlspecialchars($poll['selection1']) ?></button>
      <button id="answer-2" class="answer"><?= htmlspecialchars($poll['selection2']) ?></button>
      <button id="answer-3" class="answer"><?= htmlspecialchars($poll['selection3']) ?></button>
      <button id="answer-4" class="answer"><?= htmlspecialchars($poll['selection4']) ?></button>
    </section>
  </main>
